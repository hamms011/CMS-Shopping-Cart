...
namespace TheCakeShop.Areas.Admin.Controllers
{
    ...
    public class ShopController : Controller
    {
        ...
        public ActionResult Categories()
        {
            ...
            using (Db db = new Db())
            {
                categoryVMList = db.Categories.ToArray().OrderBy(c => c.Sorting).Select(c => new CategoryVM(c)).ToList();
            }
        ...
        public ActionResult DeleteCategory(int id)
        {
            ...
            //TempData Message
            TempData["DM"] = "Category has been deleted.";
        ...
        public ActionResult AddProduct()
        {
            ...
            //Select list of categories to model
            using (Db db = new Db())
            {
        ...
        public ActionResult EditProduct(ProductVM model, HttpPostedFileBase file)
        {
            ...
            if (file != null && file.ContentLength > 0)
            {
                ...
                DirectoryInfo del1 = new DirectoryInfo(pathString1);
                DirectoryInfo del2 = new DirectoryInfo(pathString2);

                foreach (FileInfo file2 in del1.GetFiles())
                {
                    file2.Delete();
                }

                foreach (FileInfo file3 in del2.GetFiles())
                {
                    file3.Delete();
                }
        ...
        public ActionResult DeleteProduct(int id)
        {
            ...
            //Set TempData message
            TempData["DM"] = "Product has been deleted!";
